import{o as te}from"./rolldown-runtime-D1cXj70v.js";import{t as re}from"./react-YjNwjyai.js";import{$ as oe,D as ie,O as ae,Q as se,_ as le,b as K,g as de,h as ue,m as ce,tt as pe,v as fe}from"./context-BKQSIO-z.js";import{t as ge}from"./loader-circle-B7dM0yfH.js";import{t as me}from"./play-D61Vkt-Q.js";import{t as ye}from"./server-CCMVfMdv.js";import{t as he}from"./useTranslation-C3cnxdnv.js";import{v as k}from"./src-eF5MZGZR.js";import{Ft as Q,J as _e,O as ve,Pt as M}from"./src-CgXccuRL.js";import{F as be}from"./src-NtVxQrxe.js";import{t as je}from"./processing-history-LxedDUIo.js";import{t as xe}from"./pyodide-config-BpbSw8T-.js";import{t as we}from"./duckdb-processing-B-DvuT-R.js";import{t as ke}from"./ParameterField-BSzurI6T.js";var Se=`# AUTO-GENERATED \u2014 do not edit. Source of truth:
...
`,Ee=12e4,Ae=3e5,E=null,Oe=0,b=new Map,L=new Set;function Te(i){return L.add(i),()=>L.delete(i)}function Ne(i){for(const h of L)h(i)}function Pe(){return"./pyodide/pyodide-worker.js"}function Ie(){const i=new Worker(Pe()),h=new Promise((f,_)=>{let u,w=!1;const d=g=>{if(!w){w=!0,u&&clearTimeout(u),i.terminate(),E=null;for(const[a,m]of b)b.delete(a),m.reject(new Error(g))}};u=setTimeout(()=>{const g="Timed out loading the Python runtime. Check your connection and try again.";d(g),_(new Error(g))},Ee),i.onmessage=g=>{const a=g.data??{};switch(a.type){case"progress":Ne(a.phase);break;case"ready":u&&clearTimeout(u),f();break;case"result":{const m=b.get(a.id);m&&(b.delete(a.id),m.resolve({geojson:a.geojson,messages:a.messages}));break}case"error":{const m=a.message||"Pyodide error";if(a.id===void 0)d(m),_(new Error(m));else{const S=b.get(a.id);S&&(b.delete(a.id),S.reject(new Error(m)))}break}default:break}},i.onerror=g=>{const a=g.message||"Pyodide worker failed";d(a),_(new Error(a))}});return i.postMessage({type:"init",indexURL:xe(),vectorOpsSource:Se}),h.then(()=>({worker:i}))}function Ce(){return E??=Ie().catch(i=>{throw E=null,i}),E}async function Ge(i){const{worker:h}=await Ce(),f=Oe++;return new Promise((_,u)=>{const w=setTimeout(()=>{if(b.has(f)){b.delete(f),h.terminate(),E=null;for(const[d,g]of b)b.delete(d),g.reject(new Error("Pyodide worker was reset after a timeout."));u(new Error("The Python (Pyodide) operation timed out."))}},Ae);b.set(f,{resolve:d=>{clearTimeout(w),_(d)},reject:d=>{clearTimeout(w),u(d)}}),h.postMessage({type:"run",id:f,request:i})})}var o=te(re(),1),r=pe();function Re(){const i=[];for(const h of M){const f=h.group??"Tools";let _=i.find(u=>u.group===f);_||(_={group:f,tools:[]},i.push(_)),_.tools.push(h)}return i}function Ve({mapControllerRef:i}){const{t:h}=he(),f=k(e=>e.ui.vectorToolOpen),_=k(e=>e.setVectorToolOpen),u=k(e=>e.layers),w=k(e=>e.addGeoJsonLayer),d=k(e=>e.ui.processingRerun),g=k(e=>e.setProcessingRerun),a=f!==null,[m,S]=(0,o.useState)(f??M[0].id),[c,A]=(0,o.useState)({}),[x,O]=(0,o.useState)("client"),[P,T]=(0,o.useState)([]),[D,F]=(0,o.useState)(!1),[I,q]=(0,o.useState)(null),[J,U]=(0,o.useState)(!1),W=(0,o.useRef)(null),B=(0,o.useRef)(null),s=(0,o.useMemo)(()=>Q(m)??M[0],[m]),H=(0,o.useMemo)(()=>we(),[]);(0,o.useEffect)(()=>{f&&S(f)},[f]),(0,o.useEffect)(()=>{const e={};for(const n of s.parameters)n.default!==void 0&&(e[n.id]=n.default);A(e),T([]),s.requiresSidecar?O("sidecar"):s.supportsSidecar||O("client")},[s]),(0,o.useEffect)(()=>{if(!(!a||!d||d.kind!=="vector")){if(!Q(d.toolId)){T(e=>[...e,`Error: ${h("processing.history.toolUnavailable",{toolId:d.toolId})}`]),g(null);return}d.toolId===s.id&&(A({...d.parameters}),(d.engine==="client"||d.engine==="sidecar"||d.engine==="pyodide")&&O(d.engine),g(null),d.autoRun&&U(!0))}},[a,d,s,g,h]),(0,o.useEffect)(()=>{if(m!=="h3-grid"||c.source!=="bbox"||c.west!==void 0||c.south!==void 0||c.east!==void 0||c.north!==void 0)return;const e=i.current?.getMap();if(!e)return;const n=e.getBounds(),t=l=>Number(l.toFixed(6));A(l=>({...l,west:t(n.getWest()),south:t(n.getSouth()),east:t(n.getEast()),north:t(n.getNorth())}))},[m,c.source,i]),(0,o.useEffect)(()=>{if(!a)return;let e=!1;return ve().then(n=>{e||q(n.available)}).catch(()=>{e||q(!1)}),()=>{e=!0}},[a]),(0,o.useEffect)(()=>{W.current?.scrollIntoView({block:"end"})},[P]);const C=(0,o.useRef)(null),y=(0,o.useCallback)(e=>{e.startsWith("Error:")&&(C.current=e.slice(6).trim()),T(n=>[...n,e])},[]),Y=(0,o.useCallback)(e=>u.filter(n=>{if(n.type!=="geojson"||!n.geojson)return!1;if(!e?.length)return!0;const t=be(n.geojson);return e.some(l=>l==="point"&&t.hasPoint||l==="line"&&t.hasLine||l==="polygon"&&t.hasPolygon)}),[u]),$=(0,o.useMemo)(()=>{const n=new Map;if(!a)return n;for(const t of u){if(t.type!=="geojson"||!t.geojson)continue;const l=new Set;for(const p of t.geojson.features.slice(0,1e3))for(const j of Object.keys(p.properties??{}))l.add(j);n.set(t.id,[...l])}return n},[u,a]),Z=(0,o.useCallback)(e=>{const n=c[e.fieldSource??"layer"];return n&&$.get(n)||[]},[$,c]),ee=(0,o.useCallback)((e,n)=>{A(t=>{const l={...t,[e]:n};for(const p of s.parameters)p.type==="field"&&(p.fieldSource??"layer")===e&&(l[p.id]=void 0);return l})},[s]),G=(0,o.useCallback)(e=>{const n=e.visibleWhen;if(!n)return!0;const t=c[n.param];return"in"in n?t!=null&&n.in.includes(t):t==null||!n.notIn.includes(t)},[c]),N=(0,o.useCallback)((e,n)=>{if(!n.features.length){y(`No features produced for "${e}"`);return}const t=w(e,n);B.current?.addOutputLayer(e);const l=k.getState().layers.find(p=>p.id===t);l&&i.current?.fitLayer(l)},[w,y,i]),R=(0,o.useCallback)(async(e,n)=>{const t=u.find(v=>v.id===c.layer),l=u.find(v=>v.id===c.overlay);if(!t?.geojson){const v="input layer no longer exists in the project";return y(`Error: ${v}`),v}if(c.overlay&&!l?.geojson){const v="overlay layer no longer exists in the project";return y(`Error: ${v}`),v}y(`Running "${s.name}" ${e}...`);const p=await n({tool_id:s.id,geojson:t.geojson,overlay:l?.geojson,parameters:c});for(const v of p.messages)y(v);const j=p.geojson;if(j?.type==="FeatureCollection"&&Array.isArray(j.features))return N(s.name,j),null;const X="engine returned invalid GeoJSON";return y(`Error: ${X}`),X},[u,c,s,y,N]),V=(0,o.useCallback)(async()=>{T([]),C.current=null;for(const n of s.parameters){if(!n.required||!G(n))continue;const t=c[n.id];if(t===void 0||t===""||t===null||n.type==="number"&&Number.isNaN(t)){y(`Error: "${n.label}" is required`);return}}const e=je({kind:"vector",toolId:s.id,toolName:s.name,engine:x,parameters:c});B.current=e,F(!0);try{let n=null;if(x==="sidecar")n=await R("on the Python sidecar",_e);else if(x==="pyodide"){const l=Te(p=>y(`${p}...`));try{n=await R("in your browser (Pyodide)",Ge)}finally{l()}}else{const l={layers:u,parameters:c,log:y,fitBounds:p=>i.current?.fitBounds(p),addResultLayer:N,duckdb:H,viewportBounds:()=>{const p=i.current?.getMap();if(!p)return null;const j=p.getBounds();return[j.getWest(),j.getSouth(),j.getEast(),j.getNorth()]}};await s.run(l)}const t=n??C.current;t?e.finish("error",t):e.finish("success")}catch(n){y(`Error: ${n.message}`),e.finish("error",n.message)}finally{F(!1)}},[s,c,x,u,y,N,R,i,G,H]),z=(0,o.useRef)(V);(0,o.useEffect)(()=>{z.current=V}),(0,o.useEffect)(()=>{J&&(U(!1),z.current())},[J]);const ne=(0,o.useMemo)(Re,[]);return(0,r.jsx)(ce,{open:a,onOpenChange:e=>{e||_(null)},children:(0,r.jsxs)(ue,{className:"max-w-3xl",children:[(0,r.jsxs)(le,{children:[(0,r.jsx)(fe,{children:"Vector tools"}),(0,r.jsx)(de,{children:"Run common vector geometry operations on your GeoJSON layers."})]}),(0,r.jsxs)("div",{className:"flex gap-4",children:[(0,r.jsx)(K,{className:"h-[22rem] w-48 shrink-0 rounded-md border",children:(0,r.jsx)("div",{className:"p-1",children:ne.map(e=>(0,r.jsxs)("div",{className:"mb-1",children:[(0,r.jsx)("div",{className:"px-2 py-1 text-xs font-medium text-muted-foreground",children:e.group}),e.tools.map(n=>(0,r.jsx)("button",{type:"button",onClick:()=>S(n.id),className:oe("w-full rounded-md px-2 py-1.5 text-start text-sm transition-colors hover:bg-accent",n.id===m&&"bg-accent font-medium text-accent-foreground"),children:n.name},n.id))]},e.group))})}),(0,r.jsxs)("div",{className:"flex min-w-0 flex-1 flex-col gap-3",children:[(0,r.jsx)("p",{className:"text-sm text-muted-foreground",children:s.description}),(0,r.jsx)("div",{className:"flex flex-col gap-3",children:s.parameters.filter(G).map(e=>(0,r.jsx)(ke,{param:e,value:c[e.id],layerOptions:Y(e.geometryFilter),fieldOptions:e.type==="field"?Z(e):void 0,onChange:n=>ee(e.id,n)},e.id))}),s.supportsSidecar||s.requiresSidecar?(0,r.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,r.jsxs)(ie,{className:"flex items-center gap-1.5 text-xs",children:[(0,r.jsx)(ye,{className:"h-3.5 w-3.5"})," Engine"]}),(0,r.jsxs)(ae,{value:x,onChange:e=>O(e.target.value),children:[(0,r.jsx)("option",{value:"client",disabled:s.requiresSidecar,children:"Client (Turf.js)"}),(0,r.jsx)("option",{value:"sidecar",children:"Sidecar (GeoPandas)"}),(0,r.jsx)("option",{value:"pyodide",children:"Python (Pyodide)"})]}),x==="sidecar"&&I===null?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:"Checking sidecar availability..."}):null,x==="sidecar"&&I===!1?(0,r.jsxs)("p",{className:"text-xs text-destructive",children:["The GeoPandas sidecar is not available. Start the sidecar with the vector extra, or switch to",s.requiresSidecar?" Python (Pyodide).":" the client engine."]}):null,x==="pyodide"?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:"Runs GeoPandas in your browser. The first run downloads the Python runtime (one-time, needs an internet connection)."}):null]}):null,(0,r.jsx)("div",{children:(0,r.jsxs)(se,{onClick:V,disabled:D||x==="sidecar"&&I!==!0,className:"gap-2",children:[D?(0,r.jsx)(ge,{className:"h-4 w-4 animate-spin"}):(0,r.jsx)(me,{className:"h-4 w-4"}),"Run"]})}),(0,r.jsxs)(K,{className:"h-24 rounded-md border bg-muted/30 p-2 font-mono text-xs",children:[P.length===0?(0,r.jsx)("span",{className:"text-muted-foreground",children:"Output will appear here."}):P.map((e,n)=>(0,r.jsx)("div",{className:"whitespace-pre-wrap",children:e},n)),(0,r.jsx)("div",{ref:W})]})]})]})]})})}export{Ve as VectorToolsDialog};
