...
DECODER_REGISTRY.set(Compression.Zstd, () => import("./zstd-BnububCf.js").then((m) => m.decode));
...
DECODER_REGISTRY.set(Compression.Lerc, () => import("./lerc-CjpY8ZA_.js").then((m) => m.decode));
/**
