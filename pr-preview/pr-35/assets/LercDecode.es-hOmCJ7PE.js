...
async function Module(t = {}) {
	...
	function x() {
		return e.locateFile ? (t = "lerc-wasm.wasm", e.locateFile ? e.locateFile(t, u) : u + t) : new URL("" + new URL("lerc-wasm-DVg5E4RS.wasm", import.meta.url).href, "" + import.meta.url).href;
		var t;
	}
	async function B(t) {
		if (!f) try {
